...
export default function BranchesPage() {
    ...
    return (<div>
      <PageHeader title="지점 관리" description="본사 및 직영, 가맹점 정보를 관리합니다.">
        ...
        <Table>
          ...
          <TableBody>
            {loading ? (Array.from({ length: 5 }).map((_, i) => (<TableRow key={i}>
                ...
                </TableRow>))) : branches.map((branch) => (<TableRow key={branch.id} onClick={() => handleRowClick(branch)} className="cursor-pointer">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                          ...
                          <AlertDialogAction className="bg-destructive hover:bg-destructive/90" onClick={() => handleDelete(branch.id)}>
                            삭제
                          </AlertDialogAction>
                        </AlertDialogFooter>
                      </AlertDialogContent>
      ...
      <BranchForm isOpen={isFormOpen} onOpenChange={setIsFormOpen} onSubmit={handleFormSubmit} branch={selectedBranch}/>
      <BranchDetails isOpen={isDetailOpen} onOpenChange={setIsDetailOpen} branch={selectedBranch} onEdit={() => selectedBranch && handleEdit(selectedBranch)}/>
    </div>);
}
