...
export function useOrders() {
    ...
    const fetchOrders = useCallback(async () => {
        try {
            ...
            const ordersData = querySnapshot.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
    ...
    const addOrder = async (orderData) => {
        ...
        try {
            ...
            const orderPayload = Object.assign(Object.assign({}, orderData), { orderDate: Timestamp.fromDate(orderDate) });
            ...
            for (const item of orderData.items) {
                ...
                await runTransaction(db, async (transaction) => {
                    ...
                    historyBatch.set(historyDocRef, {
                        ...
                        operator: (user === null || user === void 0 ? void 0 : user.email) || "Unknown User",
                        price: item.price,
