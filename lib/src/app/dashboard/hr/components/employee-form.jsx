...
export function EmployeeForm({ isOpen, onOpenChange, employee }) {
    const form = useForm({
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4 py-4">
            ...
            <FormField control={form.control} name="email" render={({ field }) => (<FormItem>
             ...
             <FormField control={form.control} name="contact" render={({ field }) => (<FormItem>
            ...
            <FormField control={form.control} name="department" render={({ field }) => (<FormItem>
             ...
             <FormField control={form.control} name="birthDate" render={({ field }) => (<FormItem className="flex flex-col">
             ...
             <FormField control={form.control} name="hireDate" render={({ field }) => (<FormItem className="flex flex-col">
