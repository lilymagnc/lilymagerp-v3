...
export function MaterialForm({ isOpen, onOpenChange, onSubmit, material }) {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <FormField control={form.control} name="mainCategory" render={({ field }) => (<FormItem>
               ...
               <FormField control={form.control} name="midCategory" render={({ field }) => (<FormItem>
            ...
            <div className="grid grid-cols-2 gap-4">
                <FormField control={form.control} name="size" render={({ field }) => (<FormItem>
                ...
                <FormField control={form.control} name="color" render={({ field }) => (<FormItem>
            ...
            <FormField control={form.control} name="supplier" render={({ field }) => (<FormItem>
             ...
             <FormField control={form.control} name="branch" render={({ field }) => (<FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      {branches.filter(b => b.type !== '본사').map(branch => (<SelectItem key={branch.id} value={branch.name}>{branch.name}</SelectItem>))}
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>)}/>
             {material && (<FormField control={form.control} name="stock" render={({ field }) => (<FormItem>
