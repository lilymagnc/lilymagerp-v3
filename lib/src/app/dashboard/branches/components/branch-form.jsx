...
export function BranchForm({ isOpen, onOpenChange, onSubmit, branch }) {
    const form = useForm({
      ...
      <DialogContent className="sm:max-w-[520px]">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <FormField control={form.control} name="manager" render={({ field }) => (<FormItem>
                ...
                <FormField control={form.control} name="employeeCount" render={({ field }) => (<FormItem>
             ...
             <FormField control={form.control} name="businessNumber" render={({ field }) => (<FormItem>
            ...
            <FormField control={form.control} name="account" render={({ field }) => (<FormItem>
