...
export default function NewMonthlyChecklistPage() {
    ...
    const loadTemplate = async () => {
      try {
        ...
        if (templateData) {
          ...
          // Monthly 항목들만 필터링하여 초기화
          const monthlyItems = templateData.items
  ...
  const getCurrentMonth = () => {
    return format(new Date(selectedDate), 'yyyy년 M월', { locale: ko });
  };
    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="notes">월간 메모</Label>
            <Textarea
              id="notes"
              value={notes}
        ...
        <CardContent>
          {!checklistId ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 mb-4">월간 체크리스트를 생성하면 업무를 체크할 수 있습니다.</p>
              <Button 
