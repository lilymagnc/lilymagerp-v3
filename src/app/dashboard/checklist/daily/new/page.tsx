...
export default function NewDailyChecklistPage() {
    ...
    const loadTemplate = async () => {
      try {
        ...
        if (templateData) {
          ...
          // Daily 항목들만 필터링하여 초기화
          const dailyItems = templateData.items
            ...
            <div className="space-y-2">
              ...
              <Select value={weather} onValueChange={setWeather}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="안개">안개</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">
            {format(new Date(selectedDate), 'yyyy년 M월 d일 (E)', { locale: ko })} 체크리스트
          </p>
        </CardHeader>
        <CardContent>
          {!checklistId ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 mb-4">체크리스트를 생성하면 업무를 체크할 수 있습니다.</p>
              <Button 
