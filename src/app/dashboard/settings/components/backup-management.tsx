        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">백업 데이터는 Firestore에 안전하게 저장됩니다.</p>
            </div>
                ...
                <div key={backup.id} className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium">{backup.type === "auto" ? "자동 백업" : "수동 백업"}</span>
                    </div>
                    <div className="text-sm text-gray-500">{formatDate(backup.timestamp)}</div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm">{backup.status === "completed" ? "완료" : "실패"}</span>
                    </div>
                  </div>
