...
const PrintableContent = React.forwardRef<HTMLDivElement, { order: Order | null }>(({ order }, ref) => {
  ...
  return (
    <>
      ...
      <div style={{ display: "none" }}>
        <PrintableContent ref={printableComponentRef} order={selectedOrder} />
      </div>
      ...
      {isPrintDialogOpen && (
        <OrderPrintDialog
            ...
            order={selectedOrder}
            branches={branches}
            printableRef={printableComponentRef}
        />
      )}
    </>
  );
