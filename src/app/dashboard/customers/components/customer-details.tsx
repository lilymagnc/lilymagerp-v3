  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-x-8 py-4 max-h-[70vh] overflow-y-auto pr-4">
            ...
            <div className="space-y-4">
                <h4 className="font-semibold text-lg">최근 주문 내역</h4>
